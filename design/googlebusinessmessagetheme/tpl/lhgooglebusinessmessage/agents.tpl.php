            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="..." style="width:60px;">
                        ...
                        <a class="btn btn-danger btn-xs csfr-post csfr-required" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('kernel/messages','Are you sure?');?>')" href="<?php echo erLhcoreClassDesign::baseurl('googlebusinessmessage/deleteagent')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">&#xE872;</i></a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
